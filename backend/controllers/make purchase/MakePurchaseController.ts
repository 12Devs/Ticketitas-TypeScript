...
class MakePurchaseController {
    ...
    public async handle (request: Request, response: Response) {
        ...
        const {pistaAmount, stageAmount, vipAmount, pistaAmountHalf, stageAmountHalf, vipAmountHalf, freeAmount, clientCpf, email, eventId } = request.body;

        await this.makePurchaseUseCase.execute(pistaAmount, stageAmount, vipAmount, pistaAmountHalf, stageAmountHalf, vipAmountHalf, freeAmount, clientCpf, email, eventId );
